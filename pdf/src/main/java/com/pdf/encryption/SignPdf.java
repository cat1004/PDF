...
public class SignPdf {
  ...
  public static final String KEYSTORE = "D:\\keys\\client1.p12";
  public static final char[] PASSWORD = "123456".toCharArray(); // keystory密码
  public static final String SRC = "D:/temp/myFirstPDF.pdf";
  public static final String DEST = "D:/temp/myFirstPDF2.pdf";
  ...
  public static void sign() throws Exception {
    try {
      ...
      //      app.sign(SRC, String.format(DEST, 1), chain, pk, DigestAlgorithms.SHA1,
      // provider.getName(), CryptoStandard.CMS, "Test 1", "Ghent");
      //      app.sign(SRC, String.format(DEST, 2), chain, pk, "SM3", provider.getName(),
      // CryptoStandard.CADES, "Test 2", "Ghent");
      app.sign(
          SRC,
